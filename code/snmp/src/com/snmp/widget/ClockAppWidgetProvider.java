...
public class ClockAppWidgetProvider extends AppWidgetProvider {
    private static String TAG = "ClockAppWidgetProvider";
    private ComponentName mComponentName;

    public static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int updateAppWidget) {
        LogUtils.i(TAG, "updateAppWidget()");
        RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.appwidget_provider_clock);

        String string = context.getString(R.string.full_wday_month_day_no_year);
