...
public class SendTxApi extends BaseSendTxApi {
    ...
    private static final String SEND_API = "https://mempool.space/api/tx";
    private static final String SEND_API_TESTNET = "https://mempool.space/testnet/api/tx";
    ...
    public String sendTxNewThread(String tx) {
        ...
        ToastUtils.show(ApiMgr.TYPE_MEMPOOL + response);
        EventListenerMgr.onEvent(EventListenerMgr.EVENT_UI_UPDATE, ApiMgr.TYPE_MEMPOOL + response);
        return response;
    }
